...
export default function Home() {
  ...
  return (
   ...
   <section className="overflow-x-hidden bg-[linear-gradient(270deg,rgba(0,0,0,0)_21.89%,rgba(0,0,0,0.6)_100%),url('https://res.cloudinary.com/chiaka/image/upload/v1760092279/banner_sdxdxe.png')] bg-cover bg-center w-full min-h-screen">
    ...
    <div className="mt-[339px] mb-[50px] px-[16px] md:px-[20px] xl:px-0 max-w-[1372px] mx-auto">
      <div className="space-y-[20px] text-[#fff] max-w-[746px]">
      <div className="bg-[#0000001A] p-[5px] border border-[#FFFFFF1A] text-[14px] leading-[20px] font-[500] rounded-full flex gap-x-[5px] w-[360px] items-center">
      ...
      <h1 className="font-[400] text-[56px] leading-[110%] tracking-[-2%]">
        The World's First AI-Powered Automotive <span className="font-[var( --font-instrument-serif)]">Encyclopedia</span> Super App
      </h1>
      </div>

      <div className="flex justify-between items-start mt-[20px] text-[#fff]">
      ...
      <div className="flex items-center gap-x-[13px]">
        <Button name="Join the Waitlist Now" classname="cursor-pointer w-[193px] h-[48px] py-[12px] bg-[#E6C850]" />
        <button className="cursor-pointer flex justify-center bg-[#fff] gap-x-[6px] items-center w-[149px] h-[48px] font-[600] text-[16px] leading-[24px] text-[#000] rounded-[8px] py-[12px] border border-[#D5D7DA]">
      ...
      {/* monthly giveaway */}
      <div className="w-[357px] h-full py-[28px] px-[24px] bg-[#00000033] border-[6px] border-t-[#FFDE59] border-x-0 border-b-0 rounded-[8px]">
