...
const WaitList = () => {
    return(
        <section className="w-full px-[16px] md:px-[20px] xl:px-0 pb-[100px]">
            <div className="max-w-[1374px] mx-auto bg-[#FFDE59] rounded-[14px] py-[80px] px-[10px] relative">
            {/* abstract image left */}
            ...
            <div className="max-w-[609px] mx-auto text-center">
                <h3 className="text-[56px] leading-[120%] text-[#383838]">Join the Waitlist Now</h3>
                ...
                <form className="mt-[40px] w-full">
                    <div className="w-full flex justify-between gap-[8px]">
                        ...
                        className="outline-none px-[24px] placeholder-[#fff] bg-[#00000033] w-[459px] h-[60px] rounded-[8px] backdrop-blur-[5.116238117218018px] border border-[#FFFFFF33]" 
                        />
                        <button className="w-[142px] h-[60px] rounded-[8px] bg-[#FFFAE6] text-[#060606] font-[600]">Subscribe</button>
                    </div>
